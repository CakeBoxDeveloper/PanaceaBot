...
PLUS_TEXT = (
    ...
    "· История не удаляется через 24 часа — все сеансы хранятся в архиве бессрочно\n"
    "· Голосовой ввод и озвучивание ответов — говори вместо того чтобы печатать, и слушай ответы моделей вслух\n"
    "· Интерактивные тесты в ходе разговора — модели могут присылать тесты и опросники прямо в чат для более точного анализа\n"
    "· Без ограничений на количество сеансов — начинай новый разговор в любое время\n\n"
    "Выбери вариант:"
)
...
def plus_article_keyboard() -> dict:
    """Клавиатура для статьи kb_plus — с кнопками покупки."""
    return raw_keyboard([
        [
            btn("Купить себе", callback_data="plus_self", style="success"),
            btn("Подарить другу", callback_data="plus_gift", style="success"),
